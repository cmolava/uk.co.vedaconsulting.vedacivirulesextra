 ...
 */
class CRM_Vedacivirulesextra_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Vedacivirulesextra_Upgrader(
        'uk.co.vedaconsulting.vedacivirulesextra',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_Vedacivirulesextra_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
